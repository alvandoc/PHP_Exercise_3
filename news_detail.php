      ...
      <div class="container">
        ...
        ?>
          <div class="newsitemd">
            ...
            <p class="crt_date">Create date : <?= $news['createdate']; ?></p>
            <div class="clear"></div>
            <p class="news_desc">
              <img src="news_images/<?= $news['images']; ?>" align="left">
              <?= $news['description']; ?>
            </p>
          </div>
        ...
        <!------------- Form Comment ---------------------------------------------->
        <form class="comment_form" action="process/adding_comment.php" method="post">
