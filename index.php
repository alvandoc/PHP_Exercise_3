    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <div id="content_top">
                    <div class="section"><img src="images/Bussines_Planning.png">
                        <p>Progress is one of free website templates created by TemplateMonster.com, optimized for 1024x768 res. </p><a href="#">Read More</a>
                    </div>
                    <div class="section"><img src="images/Business_Strategies.png">
                        <p>This Progress Template goes with two packages – with PSD source files and without them </p><a href="#">Read More</a>
                    </div>
                    <div class="section"><img src="images/Powerful_Analytic.png">
                        <p>PSD source files are available for free for registered members. The basic package is available for anyone </p><a href="#">Read More</a>
                    </div>
                    <div class="last-section"><img src="images/World_Wide_Sols.png">
                        <p>This website template has several pages: Home, News, Services, Products, Contacts (contact form doesn’t work). </p><a href="#">Read More</a>
                    </div>
                </div>
